...
<html lang="en">
  <head>
    <title>
      Cincinnati Landscape Designer | Hanna Landscaping and Design | Contact
    </title>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, user-scalable=no" />
    <meta
      name="description"
      content="Hanna Landscaping and Design serves Cincinnati and its suburbs in complete yard and lawn landscape installation, maintenance, and replacement."
    />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta
      property="og:title"
      content="Cincinnati Landscape Designer | Hanna Landscaping and Design | Contact"
    />
    <meta
      property="og:description"
      content="Hanna Landscaping and Design serves Cincinnati and its suburbs in complete yard and lawn landscape installation, maintenance, and replacement."
    />
    <meta property="og:url" content="https://hannalandscaping.com/" />
  ...
  <body>
    ...
    <div id="page-wrap">
      <div class="row0">
        <div class="col-2-3">
          <a href="index.html" id="hlink">
            ...
            <header>
              <h1 title="Hanna Landscaping and Design">
        ...
        <div class="col-1-3">
          <header>
            <h2 id="right" itemprop="telephone">
              513.708.7765
              <img id="phone" src="./images/mobile.svg" alt="telephone" />
              <a
                href="https://search.google.com/local/writereview?placeid=ChIJbT32zHhWQIgRZUZQMrpnBpU"
                rel="publisher"
                target="_blank"
                ><img id="newreview" src="./images/g+29.png" alt="Google+" />
              </a>
            </h2>
      ...
      <p id="left">
        Please use the contact form below to send us any information we may
        need.
      </p>
...
<?php if (isset($_POST['submit']) && $_POST['submit'] == 'submit') {
        ...
        if (empty($contactName) || empty($email) || empty($message)) {
          ...
          $reply =
            "Thank you for contacting Adam at Hanna
            Landscaping and Design. We will be in touch.\n\n" .
            "Best regards,\n\n" .
            "Adam Hanna\n" .
          ...
          echo "<p class='left'>
              Thank you for contacting Adam at Hanna Landscaping and Design. We will
              be in touch.
            </p>";
        }
      } ?>
      ...
      <div class="row1">
        ...
        <div class="col-1-2">
          <div class="mod2_contact">
            <img
              id="plant"
              src="./images/cutplant.jpg"
              alt="young plant in soil"
            />
          </div>
        </div>
      </div>
    ...
    <div class="row_footer">
      <div class="col-whole">
        <footer>
          &copy;2026 &middot;
          <span itemprop="name">Hanna Landscaping and Design</span> &middot;
          adam@hannalandscaping.com &middot;
          <span itemprop="telephone">513.708.7765</span>
        </footer>
      </div>
    </div>
    <!--end row_footer-->
